...
<body>
  ...
  {{ Form::open(['url'=> 'upload', 'class'=>'form box-padding']) }}
    <div class="form-actions form-group">
      {{ Form::file('file',['class'=>'form-control','required']) }}<br>
      {{ Form::submit( 'Upload CSV', ['id' => 'btn-add-option', 'class' => 'btn btn-primary']) }}
    </div>
  {{ Form::close() }}
